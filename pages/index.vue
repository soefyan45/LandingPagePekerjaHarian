    ...
    <header class="h-24 sm:h-32 flex items-center z-30 w-full">
        <div class="container mx-auto px-6 flex items-center justify-between">
            <div class="uppercase text-gray-800 dark:text-white font-black text-3xl">
                ...
                <img class="h-12" src="@/assets/logo_pekerjaharian.png" alt="">
            </div>
            <div class="flex items-center">
                <nav class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden">
                    <a href="#" class="py-2 px-6 flex text-green-500 font-medium border-b-2 border-green-700">
                        Home
                    </a>
        ...
        <div class="container mx-auto px-6 flex flex-col justify-between items-center relative py-8">
            <div class="flex flex-col">
                <h1 class="font-light w-full uppercase text-center text-4xl sm:text-5xl dark:text-white text-gray-800">
                    Aplikasi Pekerja Harian Untuk Saling Memberikan Manfaat
                </h1>
            ...
            <div class="block w-full mx-auto mt-2 md:mt-0 relative">
                <img src="@/assets/PekerjaHarian.png" class="max-w-xs md:max-w-2xl m-auto"/>
            </div>
        </div>
    </div>
</main>
